...
def test_get_true_dot_position():
    ...
    answers = [[np.array([1. , 0.5, 0.5]), np.array([1., 0., 0.]), np.array([ 1. , -0.5,  0.5])],
                [np.array([2. , 2.5, 2.5]), np.array([2., 2., 2.]), np.array([2. , 1.5, 2.5])],
                [np.array([-1. ,  0.5,  0.5]), np.array([-1.,  0.,  0.]), np.array([-1. , -0.5,  0.5])],
                [np.array([-2. , -1.5, -1.5]), np.array([-2., -2., -2.]), np.array([-2. , -2.5, -1.5])]]
